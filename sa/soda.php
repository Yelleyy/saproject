...
<html lang="en">
<head>
<body style="background-color:D18063;">    
    <meta charset="UTF-8">
...
<div class="container">
    ...
    <?php   
  include("server.php");
  $sql = "select * from stock where type='soda' order by id";
  $result = mysqli_query($conn, $sql);
    echo '<div class="album py-5 " style="background-color: FCD647 ;">';
    echo '    <div class="container">';
    echo '      <div style="background-color: FFECB5 ;" > ';
    echo '       <h1 align ="center" class="display-5" style="color: brown;"> Soda </h1>';
    echo '        </div>';
    ...
    echo '            <div class="card shadow align-items-center">';
             echo " <img src='img/" . $row["pic"] ." '  width='200'height='350'>"; 
...
<footer class="footer mt-auto py-3 bg-light">
    <div class="container">
      <span class="textfw-bold fw-bold">Copyright © 2021 - <a href="index.php" style="color: black;">DataFé</a> by Yelley <br>Phone : 099-989-0909<br> Location : 91/9 บ้าน E404 วงศ์สว่างซอย 7 ถนนวงศ์สว่าง แขวงบางซื่อ เขตบางซื่อ กรุงเทพมหานคร 10800 </span>
    </div>
  </footer>
</html>